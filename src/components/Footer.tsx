    ...
    <footer className="border-t border-white/10 bg-[#030712] pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-16 mb-16 md:mb-20">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 leading-relaxed max-w-sm mb-10 text-[1.05rem]">
              Layanan copywriting profesional untuk UMKM dan bisnis kecil yang ingin meningkatkan penjualan dengan copy yang menjual.
            </p>
          ...
          <div>
            <h4 className="text-white font-bold mb-6 uppercase text-xs tracking-widest opacity-60">Menu</h4>
            <ul className="space-y-4 text-gray-400 font-medium text-sm">
              ...
              <li><a href="#portfolio" className="hover:text-primary-400 transition-colors">Portofolio</a></li>
              <li><a href="#pricing" className="hover:text-primary-400 transition-colors">Harga</a></li>
              <li><a href="#contact" className="hover:text-primary-400 transition-colors">Kontak</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-white font-bold mb-6 uppercase text-xs tracking-widest opacity-60">Hubungi</h4>
            <ul className="space-y-4 text-gray-400 font-medium text-sm">
              <li><a href="https://wa.me/6281234567890?text=Hi%20CopyMojo" target="_blank" rel="noreferrer" className="hover:text-primary-400 transition-colors">WhatsApp</a></li>
              <li><a href="mailto:contact@copymojo.id" className="hover:text-primary-400 transition-colors">Email</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between text-xs font-bold uppercase tracking-widest text-gray-500">
          <p>© {new Date().getFullYear()} CopyMojo. Semua hak dilindungi.</p>
          <p className="mt-4 md:mt-0 opacity-60">Copywriting Profesional untuk UMKM.</p>
        </div>
      </div>
    </footer>
  );
